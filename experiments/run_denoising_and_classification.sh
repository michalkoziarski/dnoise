...
for noise in "${noises[@]}"
do
    sbatch script.sh denoising_and_classification.py -train_noise "$noise" -test_noise "$noise"
    sbatch script.sh denoising_and_classification.py -train_noise "$noise" -test_noise None
done
